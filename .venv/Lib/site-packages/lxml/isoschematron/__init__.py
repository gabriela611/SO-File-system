...
import sys
import os.path
from lxml import etree as _etree # due to validator __init__.py signature
...
# helper function for use in Schematron __init__.py
...
class Schematron(_etree._Validator):
    ...
    def _extract(self, element):
        ...
        This method will only be called by __init__.py if the given schema document
